...
module.exports = function nodeadmin(app, port) {
  ...
  app.use('/apparentadmin', express.static(__dirname + '/public'));
  ...
  // ** Routes
  app.use('/apparentadmin/api/auth', auth);
  app.use('/apparentadmin/api/db', database);
  app.use('/apparentadmin/api/settings',settings);
  app.use('/apparentadmin/api/system',system);
  app.use('/apparentadmin/api/home',home);
