...
module.exports = function nodeadmin(app, port) {
  ...
  // ** Third party middleware admin_dash
  app.use(morgan('dev', {
    stream:accessLogStream
  }));
  app.use(bodyParser.json());
  app.use(bodyParser.urlencoded({extended: true}));
  app.use('/apparent_admin_dash', express.static(__dirname + '/public'));
  ...
  // ** Routes
  app.use('/apparent_admin_dash/api/auth', auth);
  app.use('/apparent_admin_dash/api/db', database);
  app.use('/apparent_admin_dash/api/settings',settings);
  app.use('/apparent_admin_dash/api/system',system);
  app.use('/apparent_admin_dash/api/home',home);
